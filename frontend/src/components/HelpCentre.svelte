...
<main class="p-4">
  ...
  <div class="mt-4">
    ...
    <textarea id="content" bind:value={article.content} class="w-full p-2 border rounded h-64" on:input={updatePreview}></textarea>
  </div>
  <button class="mt-4 p-2 bg-blue-500 text-white rounded" on:click={saveArticle}>Save Article</button>
