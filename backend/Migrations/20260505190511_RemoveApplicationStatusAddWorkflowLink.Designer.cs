...
namespace Backend.Migrations
{
    ...
    [Migration("20260505190511_RemoveApplicationStatusAddWorkflowLink")]
    partial class RemoveApplicationStatusAddWorkflowLink
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormBuilder.Backend.HelpArticle", b =>
                {
                    ...
                    b.Property<bool>("ShowInAdminPortal")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowInBrokerPortal")
                        .HasColumnType("bit");

                    b.Property<bool>("ShowInCustomerPortal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FormBuilder.Backend.IntegrationSetting", b =>
                {
                    ...
                    b.HasIndex("Integration", "Key")
                        .IsUnique();

                    b.ToTable("IntegrationSettings");
                });

            modelBuilder.Entity("FormBuilder.Backend.ProfileSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
