...
namespace Backend.Migrations
{
    ...
    [Migration("20260506120000_AddConditionValuesAndStepConditions")]
    partial class AddConditionValuesAndStepConditions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormBuilder.Backend.Application", b =>
                {
                    ...
                    b.HasIndex("PublicReference").IsUnique();
            ...
            modelBuilder.Entity("FormBuilder.Backend.FieldCondition", b =>
                {
                    ...
                    b.Property<string>("Value").HasColumnType("nvarchar(max)");  // NEW
            ...
            modelBuilder.Entity("FormBuilder.Backend.FormStep", b =>
                {
                    ...
                    b.Property<string>("Conditions").HasColumnType("nvarchar(max)");  // NEW
            ...
            modelBuilder.Entity("FormBuilder.Backend.IntegrationSetting", b =>
                {
                    ...
                    b.HasKey("Id");
                    b.HasIndex("Integration", "Key").IsUnique();
            ...
            modelBuilder.Entity("FormBuilder.Backend.Application", b =>
                {
                    ...
                    b.Navigation("CurrentStage"); b.Navigation("FormSchema");
                    b.Navigation("Network"); b.Navigation("Workflow");
                });
